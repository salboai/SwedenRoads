const descriptions = {
  ...
  Blggnngst: `Vägens senast registrerade beläggning fram till år 2019. Beläggningen är vägens översta lager, kallat slitlagret. Beroende på vägtyp kan vägen ha flera underliggande lager som tillsammans utgör vägens konstruktion.
