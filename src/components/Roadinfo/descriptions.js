const descriptions = {
  ...
  Läs mer om tillståndsklassificeringen i Transportföretagens rapport [Långsiktiga effekter av ett underfinansierat vägunderhåll](https://www.transportforetagen.se/nyhetslista/ny-rapport-mer-an-var-tionde-vag-ar-i-mycket-daligt-skick/).`,
  IndK2030: `Tillståndsklass 2030 nuvarande budget är den tillståndsklass en väg beräknas få år 2030 med nuvarande budgetanslag för underhåll av vägbeläggning, där nuvarande budgetanslag antas vara cirka 3,4 miljader kronor per år. Klassificeringen utgår från ett scenario där underhåll prioriteras enligt vägens Drift- och underhållsklass samt trafikmängd. Scenariot är ett möjligt utfall, men ska inte ses som en prediktion då många olika faktorer påverkar underhållsbesluten.
  
  Läs mer om tillståndsklassificeringen i Transportföretagens rapport [Långsiktiga effekter av ett underfinansierat vägunderhåll](https://www.transportforetagen.se/nyhetslista/ny-rapport-mer-an-var-tionde-vag-ar-i-mycket-daligt-skick/).`,
  IKls_2: `Tillståndsklass 2030 + 50 % är den tillståndsklass en väg beräknas få med den budget som så kostnadseffektivt som möjligt upprätthåller vägnätets nuvarande tillstånd och behåller underhållsskulden på samma nivå år 2030 som år 2020. Denna budget beräknas till cirka 5,4 miljarder kronor per år. Individuella vägars tillstånd kan variera, men vägnätets genomsnittliga tillstånd liksom underhållsskulden är detsamma som år 2020.
  
  Läs mer om tillståndsklassificeringen i Transportföretagens rapport [Långsiktiga effekter av ett underfinansierat vägunderhåll](https://www.transportforetagen.se/nyhetslista/ny-rapport-mer-an-var-tionde-vag-ar-i-mycket-daligt-skick/).`,
  IKls_3: `Tillståndsklass 2030 + 100 % är den tillståndsklass en väg beräknas få med den budget som krävs för att minimera underhållsskulden fram till år 2030. Denna budget beräknas till cirka 7,4 miljarder kronor per år. Scenariot innebär att budgeten kostnadseffektiviserats, vilket gör att individuella vägars tillstånd kan variera gentemot övriga scenarion.
  ...
  Blggnngsd: `Datum till och med år 2019 då en heltäckande beläggingsåtgärd utfördes på en mer än 100 meter lång vägsträcka. Mellan heltäckande beläggningsåtgärder förekommer regelbundet andra typer av underhållsåtgärder, t.ex. lagning av sprickor och potthål.`,
